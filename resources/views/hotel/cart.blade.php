                                ...
                                <tr>
                                    <td>
                                        <div class="thumb_cart">
                                            <img src="http://via.placeholder.com/150x150/ccc/fff/thumb_cart_1.jpg"
                                            alt="Image">
                                        </div>
                            ...
                            <div class="float-left">
                                <div class="apply-coupon">
                                    <div class="form-group">
                                        <input type="text" name="coupon-code" id="coupon_code"
                                        placeholder="Your Coupon Code" class="form-control">
                                        <span class="text-danger" id="coupon_msg" value=""></span>
                                    </div>
                                    <div class="form-group">
                                        <button type="button" class="btn_1 outline" onclick="coupon()">
                                        Apply Coupon</button>
                                    </div>
                                </div>
                            </div>
